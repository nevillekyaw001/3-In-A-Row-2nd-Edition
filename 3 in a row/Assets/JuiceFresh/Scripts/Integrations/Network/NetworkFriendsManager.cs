...
public class NetworkFriendsManager
{
	...
	public void GetFriends()
	{
		...
		if (friendsManager != null)
		{
			friendsManager.GetFriends((dic) =>
			{
				...
				FacebookManager.THIS.AddFriend(FacebookManager.THIS.GetCurrentUserAsFriend());//1.4.11
	...
	IEnumerator GetLeadboardCor()
	{
		...
		yield return new WaitUntil(() => NetworkManager.dataManager.scoreSaved == true);
